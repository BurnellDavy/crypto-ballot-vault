...
import { Vote } from "../hooks/useEncryptedVotingSystem";
...
export function Dashboard() {
  ...
  const { votes, loadVotes, contractAddress } = useVoting();
  ...
  useEffect(() => {
    ...
    // Set up periodic refresh (initial load is handled by the hook)
